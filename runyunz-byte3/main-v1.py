...
class MainHandler(BaseHandler):
    ...
    def get(self):
        ...
        for animal in animals:
            res = {'AnimalType': animal}
            for outcome in outcomes:
                res[outcome] = 0
            animal_by_outcome = animal_by_outcome + [res]
        logging.info(animal_by_outcome)
        ...
        for row in rows: 
            ...
            if animal in animals: animal_position = animals.index(animal)
            # otherwise we will store the data in the 'Other' age column
            # else: animal_position = animals.index('Other')
            ...
            outcomes_for_animal = animal_by_outcome[animal_position]
            # and increase it by one
            outcomes_for_animal[outcome] = outcomes_for_animal[outcome] + 1
        ...
        variables = {'data':json.encode(animal_by_outcome),
                     'y_labels':outcomes,
                     'x_labels':animals}
